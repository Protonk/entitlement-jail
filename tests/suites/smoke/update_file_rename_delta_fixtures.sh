...
HARNESS_BASE="/tmp/entitlement-jail-harness"
...
old_path="${RUN_DIR}/ej_update_file_old.txt"
new_path="${RUN_DIR}/ej_update_file_new.txt"
printf 'ej fixture: update file rename delta\n' >"${old_path}"
...
old_path2="${RUN_DIR}/ej_update_file_old2.txt"
new_path2="${RUN_DIR}/ej_update_file_new2.txt"
printf 'ej fixture: old2\n' >"${old_path2}"
printf 'ej fixture: new2\n' >"${new_path2}"
...
old_path3="${RUN_DIR}/ej_update_file_old3.txt"
new_path3="${RUN_DIR}/ej_update_file_new3.txt"
printf 'ej fixture: old3\n' >"${old_path3}"
